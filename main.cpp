...
void drawCross(float length, float width, float height, int column, int row)
{
	...
	float zCenter = boardZ/2 + height/2;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		drawCircle(0.25, 0.02, 0.1, 0, 0);
		 drawCross(0.01, 0.3, 0.01, 0, 1);
		drawCircle(0.25, 0.02, 0.1, 0, 2);
		 drawCross(0.01, 0.3, 0.01, 1, 0);
		 drawCross(0.01, 0.3, 0.01, 1, 1);
		 drawCross(0.01, 0.3, 0.01, 1, 2);
		drawCircle(0.25, 0.02, 0.1, 2, 0);
		 drawCross(0.01, 0.3, 0.01, 2, 1);
